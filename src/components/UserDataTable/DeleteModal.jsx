...
export default function DeleteModal({
  ...
  const handleDelete = async () => {
    await axios.delete(`${import.meta.env.VITE_API_URL}api/v1/users/${userId}`, axiosConfig).then((res) => {
      console.log(res);
                ...
                <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                  ...
                  <div className="mt-2">
                    <p className="text-sm text-gray-500">
                      Are you sure you want to delete this user? All of your data will be permanently removed. This action cannot be undone. {userId}
                    </p>
                  </div>
                </div>
              </div>
